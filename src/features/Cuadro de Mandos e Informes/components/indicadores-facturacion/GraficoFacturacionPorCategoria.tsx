    ...
    return (
      <div className="bg-white rounded-xl shadow-sm p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900">Facturación por Categoría</h3>
            <p className="text-sm text-gray-600">Distribución de ingresos</p>
          </div>
        </div>
        ...
        <div className="flex-1 space-y-3">
          {segmentos.map((segmento, index) => (
            ...
            >
              <div className="flex items-center gap-3">
                ...
                ></div>
                <span className="font-medium text-gray-900">{segmento.categoria}</span>
              </div>
          ...
          <div className="pt-3 border-t border-slate-200 mt-3">
            <div className="flex items-center justify-between">
              ...
              <span className="font-semibold text-gray-900">{formatearMoneda(total)}</span>
            </div>
          </div>
        </div>
      </div>

  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <ChevronRight className={`w-4 h-4 text-gray-500 transition-transform ${mostrarSelector ? 'rotate-90' : ''}`} />
      </button>
        ...
        <>
          ...
          <div className="absolute top-full left-0 mt-2 bg-white rounded-lg shadow-xl border-2 border-blue-200 z-20 p-4 min-w-[280px]">
            ...
            <div className="pt-4 border-t border-gray-200">
              <h4 className="text-sm font-semibold text-gray-700 mb-3">Selección personalizada</h4>

  ...
  if (!datos || (!datos.facturas && !datos.cobros && !datos.gastos)) {
    return (
      <div className="bg-white rounded-xl shadow-sm p-8 text-center">
        ...
        <h3 className="text-lg font-semibold text-gray-900 mb-2">Vista Previa de Datos</h3>
        <p className="text-gray-600">Seleccione los parámetros de exportación para ver una vista previa</p>
      </div>
    );
  }
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm p-6">
      ...
      <div className="space-y-6">
        {/* Facturas */}
        {datos.facturas && (
          <div className="ring-1 ring-slate-200 rounded-xl p-4 bg-slate-50/50">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead className="bg-slate-100">
                    <tr>
                      <th className="px-3 py-2 text-left text-slate-700 font-medium">Nº Factura</th>
                      <th className="px-3 py-2 text-left text-slate-700 font-medium">Fecha</th>
                      <th className="px-3 py-2 text-left text-slate-700 font-medium">Paciente</th>
                      <th className="px-3 py-2 text-right text-slate-700 font-medium">Total</th>
                    </tr>
                  </thead>
                ...
                <table className="w-full text-sm">
                  <thead className="bg-slate-100">
                    <tr>
                      <th className="px-3 py-2 text-left text-slate-700 font-medium">Fecha</th>
                      <th className="px-3 py-2 text-left text-slate-700 font-medium">Paciente</th>
                      <th className="px-3 py-2 text-left text-slate-700 font-medium">Método Pago</th>
                      <th className="px-3 py-2 text-right text-slate-700 font-medium">Importe</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-slate-200">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead className="bg-slate-100">
                    <tr>
                      <th className="px-3 py-2 text-left text-slate-700 font-medium">Fecha</th>
                      <th className="px-3 py-2 text-left text-slate-700 font-medium">Proveedor</th>
                      <th className="px-3 py-2 text-left text-slate-700 font-medium">Concepto</th>
                      <th className="px-3 py-2 text-right text-slate-700 font-medium">Total</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-slate-200">

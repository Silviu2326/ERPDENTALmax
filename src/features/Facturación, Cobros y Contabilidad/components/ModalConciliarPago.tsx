        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            ...
            <input
              ...
              required
              disabled={loading}
              className="w-full rounded-xl bg-white text-slate-900 ring-1 ring-slate-300 focus:outline-none focus:ring-2 focus:ring-green-500 px-3 py-2.5 disabled:bg-gray-100 disabled:cursor-not-allowed"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              disabled={loading}
              className="w-full rounded-xl bg-white text-slate-900 placeholder-slate-400 ring-1 ring-slate-300 focus:outline-none focus:ring-2 focus:ring-green-500 px-3 py-2.5 disabled:bg-gray-100 disabled:cursor-not-allowed"
            />
          </div>
          ...
          <div className="flex items-center justify-end gap-2 pt-4 border-t border-gray-200">
            <button
              ...
              onClick={onClose}
              disabled={loading}
              className="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-colors disabled:opacity-50 disabled:cursor-not-allowed font-medium shadow-sm"
            >
              Cancelar
            </button>
            <button
              type="submit"
              disabled={loading}
              className="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed font-medium flex items-center gap-2 shadow-sm"
            >
              {loading ? (
                <>

...
import { ArrowLeft, Edit, Trash2, Send, PackageCheck, PackageX, Printer, CheckCircle } from 'lucide-react';
import {
    ...
    return (
      <div className="p-6">
        <div className="text-center py-12">
          ...
          <p className="text-gray-500">Cargando orden de compra...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="p-6">
      ...
      <div className="mb-6 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Orden de Compra: {orden.numeroOrden}</h1>
          ...
          <div className="space-y-2">
            ...
            {datosProveedor?.direccion && (
              <div className="mt-4 pt-4 border-t">
                <p className="text-sm text-gray-600 font-medium mb-1">Dirección:</p>
          ...
          <div className="space-y-3">
            {orden.historialEstados.map((historial, index) => (
              <div key={index} className="flex items-center gap-4 p-3 bg-gray-50 rounded-lg">
                ...
                {index < orden.historialEstados.length - 1 && (

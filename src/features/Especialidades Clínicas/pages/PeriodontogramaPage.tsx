        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-800">Periodontograma Avanzado</h1>
                <p className="text-sm text-gray-600">Diagnóstico y seguimiento periodontal</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              {periodontogramaActual ? (
                ...
                <div className="text-center py-12 text-gray-500">
                  <p className="text-lg mb-2">No hay periodontograma activo</p>
                  <p className="text-sm">Seleccione uno del historial o cree uno nuevo</p>
                </div>
              )}
            </div>
          </div>

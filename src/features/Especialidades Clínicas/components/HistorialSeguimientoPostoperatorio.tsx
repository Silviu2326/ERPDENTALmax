  ...
  return (
    <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-lg font-bold text-gray-800">Historial de Seguimiento</h3>
        <button
      ...
      {seguimientosOrdenados.length === 0 ? (
        <div className="text-center py-12 text-gray-500">
          ...
          <p className="text-lg font-medium mb-2">No hay seguimientos registrados</p>
          <p className="text-sm">Comience registrando el primer seguimiento postoperatorio</p>
        </div>
      ) : (
          ...
          {seguimientosOrdenados.map((seguimiento, index) => {
            ...
            return (
              <div
                ...
                className="border-l-4 border-blue-500 pl-4 py-4 bg-gray-50 rounded-r-lg hover:bg-gray-100 transition-colors"
              >
                ...
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-800">{fechaFormateada}</h4>
                  ...
                  <div className="mb-3">
                    <div className="flex items-start gap-2 mb-2">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-800 whitespace-pre-wrap">{seguimiento.notasEvolucion}</p>
                      </div>
                    </div>
                  </div>
                )}
                ...
                {seguimiento.adjuntos && seguimiento.adjuntos.length > 0 && (
                  <div className="mt-3">
                    <div className="flex items-start gap-2">
                      <ImageIcon className="w-4 h-4 text-gray-500 mt-1 flex-shrink-0" />
                      <div className="flex-1">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {seguimiento.adjuntos.map((adjunto, adjIndex) => (
                            <a
                              ...
                              className="inline-flex items-center gap-1 px-3 py-1 bg-blue-50 text-blue-700 rounded-lg hover:bg-blue-100 transition-colors text-sm"
                            >

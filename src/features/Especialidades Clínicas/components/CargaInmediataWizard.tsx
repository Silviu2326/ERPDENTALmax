    ...
    <div className="space-y-6">
              ...
              <div className="flex flex-col items-center flex-1">
                <div
                  className={`w-10 h-10 rounded-full flex items-center justify-center border-2 transition-all ${
                    fase.activa
                      ? 'bg-blue-600 border-blue-600 text-white shadow-sm ring-1 ring-blue-200'
                      : fase.completada
      ...
      <div className="bg-white shadow-sm rounded-xl p-6">
        {faseActual === 'Diagnóstico' && (
          <div className="space-y-6">
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-2">Fase de Diagnóstico</h2>
        ...
        {faseActual === 'Planificación' && (
          <div className="space-y-6">
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-2">Fase de Planificación</h2>
              <p className="text-gray-600">
        ...
        {faseActual === 'Cirugía' && (
          <div className="space-y-6">
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-2">Fase Quirúrgica</h2>
              <p className="text-gray-600">
        ...
        {faseActual === 'Protésico' && (
          <div className="space-y-6">
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-2">Fase Protésica</h2>
              <p className="text-gray-600">
        ...
        {faseActual === 'Finalizado' && (
          <div className="text-center py-12">
            ...
            <h2 className="text-lg font-semibold text-gray-900 mb-2">Protocolo Finalizado</h2>
            <p className="text-gray-600">
            ...
            <div>
              {getFaseIndex(faseActual) > 0 && (
                <button
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 border border-gray-300 rounded-xl text-gray-700 hover:bg-gray-50 transition-all"
                >
                  <ArrowLeft size={18} />
                  Fase Anterior
                </button>
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          <label htmlFor="guiaQuirurgica" className="block text-sm font-medium text-slate-700 mb-2">
            ...
            <div key={index} className="bg-slate-50 p-4 rounded-xl ring-1 ring-slate-200">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                <input
                  ...
                  className="px-3 py-2 text-sm rounded-xl bg-white text-slate-900 placeholder-slate-400 ring-1 ring-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-400"
                />
                <input
                  type="text"
                  placeholder="Marca"
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-3 py-2 text-sm rounded-xl bg-white text-slate-900 placeholder-slate-400 ring-1 ring-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-400"
                  />
                  <button
                    type="button"
